...
Rectangle {
    ...
    Image {
        ...
        height: (sourceSize.height * mainWindow.height) / 600 // Absicht mit der 600, weil sonst zu groß
    }
    Image {
        ...
        width: height * sourceSize.width / sourceSize.height
        height: (sourceSize.height * mainWindow.height) / 600 // Absicht mit der 600
    }
    MorzynButton {
