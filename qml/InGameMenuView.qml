...
Rectangle {
    ...
    Item {
        ...
        Flow {
            ...
            Item {
                id: continueButton
                width: Math.max(spellSelectComponentText1.width, (230 * mainWindow1.myWidth) / mainWindow.sourceWidth)
            ...
            Item {
                id: exitButton
                width: Math.max(spellSelectComponentText2.width, (230 * mainWindow1.myWidth) / mainWindow.sourceWidth)
